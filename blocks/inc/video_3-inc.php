<?php
if (get_sub_field('autoplay_video_3') == 1) :
...
// Load value.
$iframe = get_sub_field('iframe_video_3');
...
<?php
$videoType = get_sub_field('video_type_3');

if ($videoType == 'html') :
  $video_file = get_sub_field('video_file_3');
  $videoPoster = get_sub_field('video_image_3');
  if ($video_file) :
?>
  ...
  $video_iframe = get_sub_field('iframe_video_3');
  if ($video_iframe) :
  ?>
    <div class="img-sec">
