...
<?php if (get_sub_field('hide_this_block') == 0) : ?>
    <section class="c-banner-w  os-animation" data-os-animation="fadeIn" data-os-animation-delay=".5s">
        <div class="container">
            <div class="row">
                <div class="col-lg-5 col-md-5 offset-lg-1 order-md-1 d-flex align-items-<?php the_sub_field('vertical_align'); ?> os-animation" data-os-animation="fadeInUp" data-os-animation-delay=".5s">
                ...
                <div class="col-lg-6 col-md-6 order-md-0 order-lg-0 d-flex align-items-<?php the_sub_field('vertical_align'); ?> os-animation" data-os-animation="fadeInDown" data-os-animation-delay=".5s">
                    <div class="c-info">
