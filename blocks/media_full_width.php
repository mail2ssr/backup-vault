...
<?php if (get_sub_field('hide_this_block') == 0) : ?>
	<section class="<?php the_sub_field('block_top_bottom_margin'); ?> <?php the_sub_field('section_background_color'); ?> os-animation" data-os-animation="fadeIn" data-os-animation-delay=".5s">
