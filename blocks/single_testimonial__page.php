...
if (get_sub_field('hide_this_block') == 0) { ?>
    ...
    <div class="single-testimonial-inner os-animation" data-os-animation="fadeInDown" data-os-animation-delay=".5s">
        <div class="container">
            ...
            <?php if ($select_testimonial) : ?>
                <?php foreach ($select_testimonial as $post) : ?>
                    ...
                    <div class="s-testimonial">
                        <img src="<?php echo get_template_directory_uri() ?>/images/icon-testimonial-inner.svg" alt="" class="icon-commas" />
